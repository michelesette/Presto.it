                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <ul class="dropdown-menu bg-black mt-2 px-2 text-center ">
                                        ...
                                        @if (Auth::user()->is_admin)
                                            <li><a class="dropdown-item nav-link  my-3" href="{{ route('dashboard') }}"><i
                                                        class="fa-solid fa-user-tie"></i> Dashboard Admin</a></li>
                                        @elseif(!Auth::user()->is_lessor)
                                        @endif
                                        <li>
                                            <a class="dropdown-item nav-link  my-3" href="{{ route('article.create') }}"><i
                                                    class="bi bi-plus-lg"></i>Articolo</a>
                                        </li>
                                        @if (Auth::user()->is_lessor)
                                            <li>
                                                <a class="dropdown-item nav-link  my-3"
                                                    href="{{ route('announcements.create') }}"><i
                                                        class="bi bi-plus-lg"></i>Annuncio</a>
                                            </li>
                                        @endif
                                        <li>
